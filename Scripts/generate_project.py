...
project=add('project','PBXProject',attributes={'LastUpgradeCheck':'2700','BuildIndependentTargetsInParallel':'YES','TargetAttributes':{appTarget:{'CreatedOnToolsVersion':'27.0','SystemCapabilities':{'com.apple.Push':{'enabled':1},'com.apple.SignInWithApple':{'enabled':1}}}}},buildConfigurationList=projectCfg,compatibilityVersion='Xcode 14.0',developmentRegion='cs',hasScannedForEncodings=0,knownRegions=['cs','en','Base'],mainGroup=rootGroup,productRefGroup=productGroup,projectDirPath='',projectRoot='',packageReferences=[firebasePackage],targets=targetids)
